...
from achievement_distillation.model.ppo_baseline import PPOModelBaseline
...
class PPOAlgorithmBaseline(BaseAlgorithm):
    def __init__(
        self,
        model: PPOModelBaseline,
        ppo_nepoch: int,
        ppo_nbatch: int,
        clip_param: float,
        vf_loss_coef: float,
